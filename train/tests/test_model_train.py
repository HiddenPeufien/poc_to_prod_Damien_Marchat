...
from preprocessing.preprocessin import utils
...
class TestTrain(unittest.TestCase):
    ...
    def test_train(self):
        ...
        with tempfile.TemporaryDirectory() as dir_model:
            # run a training
            model_accuracy, _ = run.train(dir_model, params, model_path="path", add_timestamp=True)

        # TODO: CODE HERE
        # assert that accuracy is equal to 1.0
        self.assertEqual(model_accuracy, 1.0)
